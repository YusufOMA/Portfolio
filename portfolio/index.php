    ...
    <main>
        <nav>
            <div class="container navigatie_container">
                ...
                <ul class="nav_menu">
                    ...
                    <li><a href="#verleden">Verleden</a></li>
                    <li><a href="#filter">Filter</a></li>
                    <li><a href="#pakket">pakketten</a></li>
                    <li><a href="index-engels.php">Engels</a></li>
        ...
        <header>
            ...
            <header class="neon">
                ...
                <div class="header_right">
                    <div>
                        <h1>Hallo, mijn naam is Yusuf</h1>
                    </div>
                    <div>
                        <h2>En ik ben een: <span class="typing"></span></h2>
                    </div>
                </div>
        ...
        <div class="over-mij-text">
            ...
            <p class="tekst--header">
                Ik ben Yusuf Ozcelik en ik zit op het MediaCollege in Amsterdam. Ik zit nog in de opleiding
                Software developer. Ik kan al veel dingen zoals een website maken of dingen heel erg goed stylen zie
                hieronder bij de filter.
            </p>
        </div>
        </div>
        ...
        <div class="verleden" id="verleden">
            <h2 class="border_bottom">Mijn verleden</h2>
            </section>
                ...
                <div class="cards">
                    <div class="card">
                        <div class="logo">
                            ...
                            <h3>HTML</h3>
                            <p>Ik heb gewerkt met html en ik zit in mijn eerste jaar op het mediacollege voorheen had ik nog nooit gewerkt met html. Maar ik kan nu zeker heel veel.</p>
                    ...
                    <div class="card">
                        <div class="logo">
                            ...
                            <h3>CSS</h3>
                            <p>Ik heb gewerkt met CSS en ik zit in mijn eerste jaar op het mediacollege voorheen had ik nog nooit gewerkt met CSS. Maar ik kan nu zeker heel veel stylen.</p>
                    ...
                    <div class="card">
                        <div class="logo">
                            ...
                            <h3>PYTHON</h3>
                            <p>Ik heb gewerkt met python en ik zit in mijn eerste jaar op het mediacollege voorheen had ik nog nooit gewerkt met python. Python is ook niet mijn sterkste vak</p>
        ...
        <?php foreach ($result as $row) : ?>
            <article class="course">
                ...
                <header>
                    ...
                    <a class="btn" href="project.php?id=<?php echo $row['id']; ?>">Meer info</a>
